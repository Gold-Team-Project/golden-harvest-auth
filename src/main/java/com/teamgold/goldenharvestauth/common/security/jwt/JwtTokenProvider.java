package com.teamgold.goldenharvestauth.common.security.jwt;

import com.teamgold.goldenharvestauth.common.security.CustomUserDetailsService;
...
public class JwtTokenProvider {
    ...
    public void init() {
        ...
        log.info(String.valueOf("${jwt.secret-key}".length()));
    }
